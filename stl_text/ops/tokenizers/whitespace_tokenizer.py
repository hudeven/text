...
class WhitespaceTokenizer(nn.Module):
    ...
    Args:
        vocab_path Optional[str]: Path to vocabulary file. The file should
        contain tokens seperated by new line. trainable (bool): Indicates
        whether to add tokens to dictionary on-the-fly
