...
class XlmrDocClassificationTask(LightningModule):

    def __init__(self, text_transform: nn.Module, num_class: int = 2, lr: float = 0.01):
        super().__init__()
    ...
    def setup(self, stage: str):
        self.model = RobertaModel(out_dim=self.num_class)
